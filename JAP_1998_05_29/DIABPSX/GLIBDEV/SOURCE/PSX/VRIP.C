...
// int /*$ra*/ vsprintf(char *str /*$a0*/, char *fmt /*$a1*/, char *ap /*$a2*/)
 // line 157, offset 0x80025538
	/* begin block 1 */
		// Start line: 158
		// Start offset: 0x80025538
		// Variables:
	// 		struct FILE f; // stack offset -40
	/* end block 1 */
	// End offset: 0x80025574
	// End Line: 168
...
// int /*$ra*/ _doprnt(char *fmt0 /*$a0*/, char *argp /*$s2*/, struct FILE *fp /*$s5*/)
 // line 172, offset 0x80025584
	/* begin block 1 */
		// Start line: 173
		// Start offset: 0x80025584
		// Variables:
	// 		char *fmt; // $s6
	// 		int ch; // $a0
	...
	// 		char *digs; // stack offset -56
		...
		/* begin block 1.1 */
			// Start line: 267
			// Start offset: 0x800257A0
			// Variables:
		// 		char c; // $v0
		/* end block 1.1 */
		// End offset: 0x800257D4
		// End Line: 173

		/* begin block 1.2 */
			// Start line: 284
			// Start offset: 0x8002581C
		/* end block 1.2 */
		// End offset: 0x80025840
		// End Line: 173

		/* begin block 1.3 */
			// Start line: 345
			// Start offset: 0x80025978
			// Variables:
		// 		char *p; // $v0
		/* end block 1.3 */
		// End offset: 0x800259A4
		// End Line: 354
	/* end block 1 */
	// End offset: 0x80025D38
	// End Line: 480
...
LAB_800256d8:
			...
			case 0x2a:
				...
				argp = (char *)puVar14;
				fmt0 = (char *)pbVar16;
				if (-1 < (int)local_40) goto LAB_800256d8;
			...
			case 0x2e:
				...
				if (*fmt0 == 0x2a) {
					...
					bVar1 = *fmt0;
					__n = (undefined4 *)0x0;
					while ((bVar1 < 0x80 && (((&DAT_800b5dbd)[(uint)bVar1] & 4) != 0))) {
						iVar10 = (int)*fmt0;
						fmt0 = (char *)((byte *)fmt0 + 1);
						if (iVar10 < 0x31) {
							iVar12 = 0;
			...
			case 0x39:
				...
				do {
					...
					local_40 = (undefined4 *)((int)local_40 * 10 + iVar12);
								...
								(pbVar16 = (byte *)fmt0 + 1, ((&DAT_800b5dbd)[(uint)bVar1] & 4) != 0));
				goto LAB_800256d8;
			case 0x44:
				uVar15 = uVar15 | 1;
				bVar4 = true;
...
LAB_80025a40:
			...
			case 0x68:
				...
				goto LAB_800256d8;
			case 0x6c:
				goto switchD_80025700_caseD_6c;
			case 0x70:
				uVar11 = *(uint *)argp;
				uVar13 = 0x10;
				goto LAB_80025a40;

...
// void /*$ra*/ GSYS_MarkStack(void *Stack /*$a0*/, unsigned long StackSize /*$a1*/)
 // line 110, offset 0x8001f94c
	/* begin block 1 */
		// Start line: 112
		// Start offset: 0x8001F94C
	/* end block 1 */
	// End offset: 0x8001F954
	// End Line: 116
...

{
	...
	WorkMemInfo.Size = (GSYS_MemEnd + 0x7fe9cf50) - (int)_stacksize;
	return '\x01';
}
...
// unsigned char /*$ra*/ GSYS_CheckPtr(void *Ptr /*$a0*/)
 // line 170, offset 0x8001f9c8
	/* begin block 1 */
		// Start line: 172
		// Start offset: 0x8001F9C8
	/* end block 1 */
...
// unsigned char /*$ra*/ GSYS_IsStackOutOfBounds(void *Stack /*$s0*/, unsigned long StackSize /*$s1*/)
 // line 195, offset 0x8001f9fc
	/* begin block 1 */
		// Start line: 196
		// Start offset: 0x8001F9FC
		// Variables:
	// 		unsigned long ThisSp; // $v1
	/* end block 1 */
	// End offset: 0x8001FA40
	// End Line: 200

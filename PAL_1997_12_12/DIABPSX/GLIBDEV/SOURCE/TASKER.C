...
// struct TASK * /*$ra*/ TSK_AddTask(unsigned long Id /*$s2*/, TDRFuncPtr_TSK_AddTask1Main Main /*$s3*/, int StackSize /*$a2*/, int DataSize /*$s4*/)
 // line 141, offset 0x8001ed24
	/* begin block 1 */
		// Start line: 142
		// Start offset: 0x8001ED24
		// Variables:
	// 		struct TASK *RetTask; // $s0
	// 		long hndTask; // $s1
	// 		struct GAL_STRUCT G[4]; // stack offset -56
	/* end block 1 */
	// End offset: 0x8001EEE8
	// End Line: 212
...

{
	...
	local_20 = 0xffffffff;
	local_30 = DataSize;
	Handle = GAL_AllocMultiStruct(&local_38,MemTypeForTasker,&DAT_8011e2b4);
	ThisObj = (TASK *)0x0;
...
// original method signature: 
// void /*$ra*/ TSK_DoTasks()
 // line 218, offset 0x8001ef0c
	/* begin block 1 */
		// Start line: 219
		// Start offset: 0x8001EF0C

		/* begin block 1.1 */
			// Start line: 254
			// Start offset: 0x8001F024
			// Variables:
		// 		struct TASK *NextT; // $s0
		/* end block 1.1 */
		// End offset: 0x8001F04C
		// End Line: 264
	/* end block 1 */
	// End offset: 0x8001F0B8
	// End Line: 278
...
// unsigned char /*$ra*/ TSK_IsStackCorrupted(struct TASK *T /*$s0*/)
 // line 385, offset 0x8001f2bc
	/* begin block 1 */
		// Start line: 386
		// Start offset: 0x8001F2BC

		/* begin block 1.1 */
			// Start line: 387
			// Start offset: 0x8001F2E0
			// Variables:
		// 		int LongsOk; // $a0
		/* end block 1.1 */
		// End offset: 0x8001F2F8
		// End Line: 393
	/* end block 1 */
...
// void /*$ra*/ TSK_JumpAndResetStack(TDRFuncPtr_TSK_JumpAndResetStack0RunFunc RunFunc /*$v1*/)
 // line 408, offset 0x8001f338
	/* begin block 1 */
		// Start line: 409
		// Start offset: 0x8001F338
		// Variables:
	// 		struct TASK *T; // $a2
	/* end block 1 */
	// End offset: 0x8001F370
	// End Line: 419
...
// struct TASK * /*$ra*/ TSK_Exist(struct TASK *T /*$a0*/, unsigned long Id /*$a1*/, unsigned long Mask /*$a2*/)
 // line 482, offset 0x8001f3ec
	/* begin block 1 */
		// Start line: 484
		// Start offset: 0x8001F3EC
		// Variables:
	// 		struct TASK *ptrTask; // $v1
	// 		struct TASK *RetTask; // $a3
	/* end block 1 */
	// End offset: 0x8001F43C
	// End Line: 499
...
// int /*$ra*/ TSK_KillTasks(struct TASK *CallingT /*$s3*/, unsigned long Id /*$s4*/, unsigned long Mask /*$s5*/)
 // line 543, offset 0x8001f480
	/* begin block 1 */
		// Start line: 544
		// Start offset: 0x8001F480
		// Variables:
	// 		int TasksKilled; // $s1
	// 		struct TASK *T; // $a0
	// 		unsigned char WasCurrentTaskKilled; // $s2
		...
		/* begin block 1.1 */
			// Start line: 555
			// Start offset: 0x8001F4C0
			// Variables:
		// 		struct TASK *NextT; // $s0
		/* end block 1.1 */
		// End offset: 0x8001F51C
		// End Line: 572
	/* end block 1 */
	// End offset: 0x8001F558
	// End Line: 584
...
// void /*$ra*/ TSK_IterateTasks(unsigned long Id /*$s1*/, unsigned long Mask /*$s2*/, TDRFuncPtr_TSK_IterateTasks2CallBack CallBack /*$s3*/)
 // line 594, offset 0x8001f580
	/* begin block 1 */
		// Start line: 595
		// Start offset: 0x8001F580
		// Variables:
	// 		struct TASK *T; // $a0

		/* begin block 1.1 */
			// Start line: 602
			// Start offset: 0x8001F5B0
			// Variables:
		// 		struct TASK *NextT; // $s0
		/* end block 1.1 */
		// End offset: 0x8001F5CC
		// End Line: 609
	/* end block 1 */
	// End offset: 0x8001F5D8
	// End Line: 611
...
// void /*$ra*/ LoTskKill(struct TASK *T /*$s0*/)
 // line 722, offset 0x8001f6dc
	/* begin block 1 */
		// Start line: 723
		// Start offset: 0x8001F6DC
	/* end block 1 */
	// End offset: 0x8001F738
	// End Line: 735
...
// TDRFuncPtr_TSK_SetDoTasksPrologue /*$ra*/ TSK_SetDoTasksPrologue(TDRFuncPtr_TSK_SetDoTasksPrologue0Func Func /*$a0*/)
 // line 756, offset 0x8001f79c
	/* begin block 1 */
		// Start line: 758
		// Start offset: 0x8001F79C
		// Variables:
	// 		void (*Old)(); // $v0
	/* end block 1 */
	// End offset: 0x8001F7AC
	// End Line: 763
...
// TDRFuncPtr_TSK_SetDoTasksEpilogue /*$ra*/ TSK_SetDoTasksEpilogue(TDRFuncPtr_TSK_SetDoTasksEpilogue0Func Func /*$a0*/)
 // line 765, offset 0x8001f7b4
	/* begin block 1 */
		// Start line: 767
		// Start offset: 0x8001F7B4
		// Variables:
	// 		void (*Old)(); // $v0
	/* end block 1 */
	// End offset: 0x8001F7C4
	// End Line: 772
...
// TDRFuncPtr_TSK_SetTaskPrologue /*$ra*/ TSK_SetTaskPrologue(TDRFuncPtr_TSK_SetTaskPrologue0Pro Pro /*$a0*/)
 // line 775, offset 0x8001f7cc
	/* begin block 1 */
		// Start line: 777
		// Start offset: 0x8001F7CC
		// Variables:
	// 		void (*Old)(); // $v0
	/* end block 1 */
	// End offset: 0x8001F7DC
	// End Line: 782
...
// TDRFuncPtr_TSK_SetTaskEpilogue /*$ra*/ TSK_SetTaskEpilogue(TDRFuncPtr_TSK_SetTaskEpilogue0Epi Epi /*$a0*/)
 // line 784, offset 0x8001f7e4
	/* begin block 1 */
		// Start line: 786
		// Start offset: 0x8001F7E4
		// Variables:
	// 		void (*Old)(); // $v0
	/* end block 1 */
	// End offset: 0x8001F7F4
	// End Line: 791
...
// TDRFuncPtr_TSK_SetStackFloodCallback /*$ra*/ TSK_SetStackFloodCallback(TDRFuncPtr_TSK_SetStackFloodCallback0Func Func /*$a0*/)
 // line 819, offset 0x8001f858
	/* begin block 1 */
		// Start line: 821
		// Start offset: 0x8001F858
		// Variables:
	// 		void (*OldFunc)(); // $v0
	/* end block 1 */
	// End offset: 0x8001F868
	// End Line: 827
...
// int /*$ra*/ TSK_SetExtraStackSize(int Size /*$a0*/)
 // line 833, offset 0x8001f870
	/* begin block 1 */
		// Start line: 835
		// Start offset: 0x8001F870
		// Variables:
	// 		int OldSize; // $v1
	/* end block 1 */
	// End offset: 0x8001F890
	// End Line: 839
...
// void /*$ra*/ ExtraMarkStack(unsigned long *Stack /*$a0*/, int SizeLongs /*$a1*/)
 // line 841, offset 0x8001f898
	/* begin block 1 */
		// Start line: 842
		// Start offset: 0x8001F898
		// Variables:
	// 		int f; // $v1
	/* end block 1 */
	// End offset: 0x8001F8B8
	// End Line: 846
...
// int /*$ra*/ CheckExtraStack(unsigned long *Stack /*$a0*/, int LongsToCheck /*$a1*/)
 // line 848, offset 0x8001f8c4
	/* begin block 1 */
		// Start line: 849
		// Start offset: 0x8001F8C4
		// Variables:
	// 		unsigned long f; // $v1
	/* end block 1 */
	// End offset: 0x8001F8F4
	// End Line: 858
